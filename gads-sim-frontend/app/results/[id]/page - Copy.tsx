...
export default function Results() {
  ...
  // Generate daily trend data (simulated for demo)
  const trendData = useMemo(() => {
    if (!results) return []
    
    // Simulate 30 days of data based on campaign results
    const days = 30
    const data = []
    ...
    for (let i = 0; i < days; i++) {
      ...
      data.push({
        ...
        cpc: parseFloat((results.metrics.avg_cpc * (0.8 + Math.random() * 0.4)).toFixed(2))
      })
    }
      ...
      <div className="px-6 py-6">
        ...
        <div className="grid grid-cols-4 gap-0 mb-6">
          ...
          >
            ...
            <div className="text-4xl font-bold">${metrics.avg_cpc}</div>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {by_keyword.map((kw: any, index: number) => (
